...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_sam',               type=int,   default=0.00005,       help='learning rate to train sam')
    parser.add_argument('--lr_cnn',               type=float, default=0.00005,       help='learning rate to train cnn')
    parser.add_argument('--lr_attribute',         type=float, default=0.00005,       help='learning rate to train attribute network')
    ...
    parser.add_argument('--basemodel_dir',        type=str,   default='./results/basemodel/celeba_spatial_model',help='root dir of saving model')

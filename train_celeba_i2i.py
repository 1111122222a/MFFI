...
if __name__ == '__main__':
    ...
    parser.add_argument('--basemodel_dir', type=str, default='./results/basemodel/celeba_i2i_spatial_model',help='root dir of saving model')
    parser.add_argument('--cnn_model_dir',    type=str, default='cnn_model', help='root dir of cnn model')
    parser.add_argument('--i2i_dcm_logit_dir', type=str, default='i2i_dcm_model', help='root dir of i2i dcm logit model')
